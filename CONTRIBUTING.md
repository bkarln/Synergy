...
Welcome to the [xgest-erp-crm](<[xgest-erp-crm](https://github.com/bkarln/xgest)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/bkarln/xgestissues).
- make sure it is not work in progress here [pull requests](https://github.com/bkarln/xgestpulls).
- you can then [create an issue](https://github.com/bkarln/xgest/issues/new/choose) with the following information:
...
Thank you for contributing to [xgest-erp-crm](https://github.com/bkarln/xgest) dont forget to give us a :star: !
